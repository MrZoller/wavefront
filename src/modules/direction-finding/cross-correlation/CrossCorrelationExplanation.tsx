  ...
  return (
    <div className="flex flex-col gap-4">
      <section>
        ...
        <p>
          Drag the reference across the noisy record and watch the dot product. When the burst lines
          up with its buried copy, every term reinforces and the sum spikes.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          Random noise is just as likely to be positive as negative, so off the alignment it mostly
          cancels in the sum. Only at the true lag does the signal correlate with itself. The lag of
          the peak <em>is</em> the delay between the two recordings.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          Turn the noise up and the baseline gets ragged, but the peak survives well past the point
          where you could spot the burst by eye — correlation is a remarkably robust detector. Push
          it far enough and the peak finally drowns; that&rsquo;s the detection limit.
        </p>
      </section>
