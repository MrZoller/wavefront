      ...
      <div className="flex flex-col gap-4">
        ...
        <section>
          ...
          <p>
            ...
            that maps to one bearing. Widen the baseline and the same measured phase fits several
            true angles — every cyan ray is consistent with the measurement, and only one is the
            truth. That&rsquo;s the ambiguity a wide baseline buys (in exchange for finer accuracy).
          </p>
        </section>
