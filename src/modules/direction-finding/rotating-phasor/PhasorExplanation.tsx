    ...
    <div className="flex flex-col gap-4">
      ...
      <section>
        ...
        <p>
          ...
          imaginary part traces a sine (the Q plot). Frequency <span className="readout">f</span> is
          just how many full turns it makes per second.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          ...
          that phase difference is how you infer a bearing. It all starts with a spinning 2D point.
        </p>
      </section>
