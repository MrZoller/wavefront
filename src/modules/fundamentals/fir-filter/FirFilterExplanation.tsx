    ...
    <GlossedText>
      <div className="flex flex-col gap-4">
        <section>
          ...
          <p>
            An FIR filter slides a short list of weights along the signal and takes a weighted sum
            at each step — convolution, the same move as correlation. Feed in a single impulse and
            the output <em>is</em> the weights: the taps are the impulse response.
          </p>
        </section>
