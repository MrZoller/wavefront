  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <section>
        ...
        <p>
          A window fades the block in and out so there's no edge jump. The cost is a wider mainlobe
          (you can resolve two close tones less easily); the benefit is far lower sidelobes (a
          strong tone no longer drowns a weak neighbor). Blackman is the gentlest here — widest
          lobe, lowest sidelobes; rectangular is the opposite.
        </p>
      </section>
