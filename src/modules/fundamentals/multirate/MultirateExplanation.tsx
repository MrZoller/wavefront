    ...
    <GlossedText>
      <div className="flex flex-col gap-4">
        <section>
          ...
          <p>
            If a signal only occupies a sliver of the band, carrying it at the full rate is
            wasteful.
            <em> Decimation</em> by N keeps every N-th sample, dropping the rate (and the cost) by
            N.
