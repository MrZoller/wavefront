    ...
    <div className="flex flex-col gap-4">
      <section>
        ...
        <p>
          ...
          signal wiggles too fast between samples, those samples are equally consistent with a much
      ...
      <section>
        ...
        <p>
          The boundary is half the sample rate — the <em>Nyquist</em> frequency. Below it, a tone is
          captured faithfully. Above it, the apparent frequency <em>folds</em> back down:{' '}
