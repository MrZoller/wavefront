      ...
      <div className="flex flex-col gap-4">
        ...
        <section>
          ...
          <p>
            ...
            times, each symbol&rsquo;s neighbors contribute nothing — zero inter-symbol
            interference, even though the pulses overlap everywhere in between.
          </p>
        </section>
        ...
        <section className="rounded-md border border-border bg-surface-raised p-3 text-xs text-text-faint">
          ...
          receiver and you also get the maximum-SNR matched filter — the next module. All signals
          are synthetic.
        </section>
      </div>
    </GlossedText>
