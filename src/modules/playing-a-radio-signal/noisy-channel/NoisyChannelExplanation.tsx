      ...
      <div className="flex flex-col gap-4">
        <section>
          ...
          <p>
            ...
            <em>additive white Gaussian noise</em>. Each ideal point becomes a fuzzy cloud; the
            spread is the noise standard deviation.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            reads off the bits. When a cloud spills across a decision boundary, you get an error.
            The <em>bit error rate</em> is the fraction of bits that come out wrong — it climbs
            steeply as Eb/N0 drops or the points crowd closer.
          </p>
        </section>

        <section className="rounded-md border border-border bg-surface-raised p-3 text-xs text-text-faint">
          Hard-decision, symbol-by-symbol — no pulse shaping or coding yet (later modules). The
          noise is seeded, so the scene is reproducible. All signals are synthetic.
        </section>
      </div>
    </GlossedText>
  );
