      ...
      <div className="flex flex-col gap-4">
        ...
        <section>
          ...
          <p>
            ...
            deep notch — and where it&rsquo;s in phase, it adds. So the channel is <em>not</em>{' '}
            flat: it fades some frequencies and boosts others, depending on the delay. That&rsquo;s
        ...
        <section>
          ...
          <p>
            In time, the echo bleeds one symbol into the next, so the sampling instants no longer
            land on clean symbol values — the constellation blurs and the eye closes. Equalizers
            undo this; OFDM sidesteps it by making symbols long compared to the echo (plus the
            cyclic prefix).
          </p>
        </section>

        <section className="rounded-md border border-border bg-surface-raised p-3 text-xs text-text-faint">
          A static two-ray channel (direct + one echo). Real channels add many time-varying taps.
