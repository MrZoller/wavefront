  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <section>
        ...
        <p>
          The points are labeled so that any two neighbors differ by exactly <em>one</em> bit. When
          noise nudges a symbol to its nearest wrong neighbor — the most likely error — only a
          single bit flips, not several. It&rsquo;s a free win that every real system uses.
        </p>
      </section>
