      ...
      <div className="flex flex-col gap-4">
        ...
        <section>
          ...
          <p>
            ...
            fit twice the data on the same tone.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            Multiply the received passband by the same cosine and sine again. Each product yields
            the wanted baseband term plus an image at twice the carrier; a <em>low-pass filter</em>{' '}
            throws the image away, leaving I and Q exactly as sent.
          </p>
        </section>

        <section className="rounded-md border border-border bg-surface-raised p-3 text-xs text-text-faint">
          Idealized: the receiver&rsquo;s carrier is assumed perfectly aligned in frequency and
          phase. Recovering that alignment (carrier &amp; timing sync) is a later track. All signals
          are synthetic.
        </section>
      </div>
    </GlossedText>
