      ...
      <div className="flex flex-col gap-4">
        <section>
          ...
          <p>
            ...
            carrier frequency. If that oscillator is even slightly off, the leftover frequency
            rotates every symbol a little more than the last — the constellation spins.
          </p>
        </section>
        ...
        <section className="rounded-md border border-border bg-surface-raised p-3 text-xs text-text-faint">
          The spin rate here is slowed to be watchable; a real offset rotates far faster. All
