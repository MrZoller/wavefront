  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <section>
        ...
        <p>
          Putting a symbol on subcarrier <em>k</em> is exactly placing it in FFT bin <em>k</em>; the
          inverse FFT sums all the subcarriers into the time-domain waveform in one shot.
