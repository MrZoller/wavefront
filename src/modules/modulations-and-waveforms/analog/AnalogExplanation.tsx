  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <section>
        ...
        <p>
          AM of a single tone is exact: a carrier line plus two sidebands at ±the message frequency.
          FM and PM are nonlinear — they spray a <em>fan</em> of sidebands whose width grows with
          the deviation (Carson&rsquo;s rule), which is why FM needs more bandwidth than AM but
          rejects amplitude noise.
        </p>
      </section>
